...
{
	private final static String IMAGE_DIR = "src/Images/"; //para hacerlo ejecutable IMAGE_DIR = "Images/" para editarlo "src/Images/"
	...
	*/
	{ 
	 ...
	 { //System.out.println("Error reading file: " + imsFNm + "  Error: " +e);
	   System.exit(1);
	 }
	...
	*/
	{
	  //try {
	      BufferedImage im =  loadImage2(IMAGE_DIR + fnm);
	...
	/* Load the image from <fnm>, returning it as a BufferedImage.
	   Uses ImageIcon.
	*/
	{ ImageIcon imIcon = new ImageIcon(fnm);
	
	// mt
	//System.out.println(IMAGE_DIR + fnm);
	
	 if (imIcon == null)
	   return null;
	
	 //mt
	 //System.out.println(imIcon.getIconWidth());
	 //System.out.println(imIcon.getIconHeight());
